    ...
    <div className="p-4 relative z-10 w-full text-center">
      <div className="md:flex">
        ...
        <div className="w-full md:w-[40%] mb-10 md:mb-0 md:mt-25">
          ...
          >
            <div className="relative w-full h-full mt-15 md:mt-0 border-2 border-[#FF014F] animate-morph shadow-lg shadow-[#FF014F]/60 md:shadow-[#FF014F] overflow-hidden">
              <Image
                width={500}
                height={300}
                src={Ankit || "/placeholder.svg"}
                alt={"ankit.webp"}
        ...
        >
          ...
          <div className=" flex justify-center items-center px-4">
            <motion.div className="md:text-4xl text-2xl font-normal text-neutral-600 dark:text-neutral-300 md:block hidden">
