      ...
      <div className="md:flex">
        ...
        <div>
          ...
          <div className=" flex justify-center items-center px-4">
            <div className="md:text-4xl text-2xl font-normal text-neutral-600 dark:text-neutral-300">
              <FlipWords words={words} /> <br />
            </div>
          </div>
          <About text = {"A passionate and adaptive developer with a strong foundation in full-stack web development. Always eager to learn, I turn ideas into functional, user-focused solutions with clean and scalable code."}/>
        </div>
      </div>
