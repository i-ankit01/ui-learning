...
import farmhelp from "../assets/farm-help.png";
import spacewalk from "../assets/space-walk.png";
          ...
          {projects.map((project, index) => (
            ...
            >
              ...
              <div className="px-5 py-1 flex justify-between mb-2 md:hidden">
                <div className="w-18 h-6 px-2 bg-white rounded-full flex items-center gap-2">
                  <a
                    href={project.live}
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <div className="w-22 h-6 px-2 bg-white rounded-full flex items-center gap-2">
                  <a
                    href={project.github}
                    target="_blank"
                    rel="noopener noreferrer"
                    className=" text-black ml-1 rounded-lg"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="12"
