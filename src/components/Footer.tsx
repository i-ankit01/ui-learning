export default function Footer() {
  return (
    <footer
      id="contact"
      className="py-12 border-t px-4 md:ml-17 border-gray-800"
    >
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center mb-8">
          ...
          <div className="flex flex-col items-center md:items-end">
            ...
            <a href="mailto:its.ankit.acc@gmail.com">
              <div className="text-gray-400 mb-2 hover:text-[#FF014F] cursor-pointer transition-colors flex items-center">
                ...
                its.ankit.acc@gmail.com
              </div>
            </a>
            <a href="tel:+917830330681">
        ...
        <div className="max-w-2xl mx-auto mb-12 p-6 bg-black rounded-lg border border-[#FF014F]/30">
          ...
          <button className="w-full md:py-3 py-2 bg-[#FF014F] cursor-pointer text-black font-bold rounded-lg hover:bg-[#FF014F]/90 transition-colors">
            Send Message
          </button>
        </div>
      </div>
